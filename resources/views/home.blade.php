...
<div class="slider" x-data="{start: true, end: false}">
    <div style="">
        ...
        <p>
            ...
            کلیک کنید تا محصولات انتخابی را مشاهده کنید
...
<div class="content">
    ...
    <figure class="card__img">
        ...
        <figcaption class="card__desc">
            <div  x-data="{open:false}" style="display:flex;align-items: center;justify-content: space-between;">
                <div  @click="open =! open" :class="{red: open}"><span class="icon-heart1">  </span><span @click="open =! open" >{{$article->number}}</span></div>
                <div><span class="icon-calendar">  </span><span>{{$article->created_at}}</span></div>
            </div>
            <h2>{{$article->title}}</h2>
